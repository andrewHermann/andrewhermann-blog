...
Pricing.defaultProps = {
  ...
  plan2Feature2: 'Access to KI@V Initiative',
  plan31: 'Enterprise plan',
  plan2Yearly: '$1999/year',
  plan1Feature1: 'Organizational Strategy Consultation',
  plan1: 'Basic plan',
  plan1Feature3: 'Data-Driven Decision-Making Workshop',
  plan3Feature2: 'Full Project Portfolio Management Implementation',
  plan3Feature41: 'Feature text goes here',
  plan1Action: 'Sign up now',
  plan1Price1: '$200/yr',
  plan2Action: 'Get started',
  plan2: 'Business plan',
  plan2Feature3: 'Orion Cockpit Integration',
  ...
  plan2Feature1:
    'Applied Artificial Intelligence in Public Administration Course',
  ...
  plan1Feature2: 'Project Portfolio Management Training',
  ...
  plan3Feature3: 'Advanced Data-Driven Decision-Making Analytics',
  ...
  plan3Feature1: 'Customized Organizational Strategy Plan',
}

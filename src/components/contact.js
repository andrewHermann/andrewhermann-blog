  ...
  return (
    <div className="contact-wrapper">
      ...
      <div className="contact-info-grid">
        ...
        <div className="shared-card contact-info-card">
          <svg viewBox="0 0 1024 1024" className="contact-icon">
            <path d="M512 64c-247 0-448 201-448 448s201 448 448 448 448-201 448-448-201-448-448-448zM512 896q-38 0-74-6l98-226q14-2 22-2h4q18 50 36 99t36 101q-60 34-122 34zM170 682q-42-78-42-170 0-156 98-268l128 352q-92-20-184-114zM756 796q-86 82-200 96l-80-220 68-190q20-4 36-4 18 0 36 4l68 190-80 220q50-6 98-26zM692 614l128-352q98 112 98 268 0 92-42 170-92 94-184 114z" />
          </svg>
          <div className="contact-info-content">
            <h3>Languages</h3>

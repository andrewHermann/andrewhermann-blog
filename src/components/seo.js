...
const SEO = ({ 
  ...
  const pageUrl = url || "https://andrewhermann.com"
  ...
  return (
    <Helmet>
      ...
      <meta property="og:image" content={`https://andrewhermann.com${image}`} />
      ...
      <meta name="twitter:image" content={`https://andrewhermann.com${image}`} />

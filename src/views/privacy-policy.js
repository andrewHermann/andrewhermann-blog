...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-container">
      <Helmet>
        <title>Privacy Policy - Andrew J. Hermann</title>
        <meta property="og:title" content="Privacy Policy - Andrew J. Hermann" />
        <meta name="description" content="Privacy Policy for Andrew J. Hermann's professional website describing how we collect, use, and protect your personal information." />
      </Helmet>
      <Navbar />
      <div className="privacy-content">
        ...
        <div className="privacy-body">
          ...
          <section className="privacy-section">
            ...
            <p>
              We may use cookies, web beacons, tracking pixels, and other tracking technologies on the site to help customize the site and improve your experience. For more information on how we use cookies, please refer to our Cookie Policy posted on the site, which is incorporated into this Privacy Policy.
            </p>

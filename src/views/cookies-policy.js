  ...
  return (
    <div className="cookies-container">
      <Helmet>
        ...
        <meta name="description" content="Cookies Policy for Andrew J. Hermann's professional website detailing how cookies and similar technologies are used." />
      </Helmet>
      <Navbar />
      <div className="cookies-content">
        ...
        <div className="cookies-body">
          ...
          <section className="cookies-section">
            ...
            <p>
              If you have any questions about our use of cookies or other technologies, please <Link to="/contact" className="contact-link">contact us through our contact form</Link> or refer to our <Link to="/privacy">Privacy Policy</Link> for more information about how we process personal data.
            </p>
            <p>

      ...
      <div className="page-content">
        ...
        <div className="content-main">
          ...
          <div className="section-card" id="ki-v">
            ...
            <h3>Ziel: Aufbau einer produktionstauglichen KI-Plattform für die Gruppe Verteidigung, betrieben innerhalb der Bundesinfrastruktur, zertifiziert nach Cloud-Stufe III und funktionsfähig über die Organisationsgrenzen von ASTAB, armasuisse und RUAG hinweg.</h3>

            <h3>Meine Rolle:</h3>
            <p>
              Ich initiierte KI@V im Dezember 2022 als Projektleiter innerhalb des ASTAB und leite das Projekt
              seither. Nach Genehmigung der Evolve-Phase im Mai 2026 trat die Plattform im Juni 2026 in den
              aktiven Pilotbetrieb für den ASTAB ein.
            </p>
            <p>
            ...
            <h3>Ergebnisse:</h3>
            <ul>
              <li>Evolve-Phase genehmigt durch den Innovationsboard ASTAB am 6. Mai 2026, mit vollständiger Finanzierung für Service-Setup und Pilotbetrieb</li>
              ...
              <li>Validierter ROI über drei Anwendungsfälle (CV-Abgleich, Personalgewinnung, SAP-Beschaffung), mit bestätigter Amortisation durch unabhängige Wirtschaftlichkeitsvalidierung mit der HSLU</li>
              <li>1&apos;940 Arbeitsstunden zurückgewonnen über die validierten Anwendungsfälle</li>
              <li>Eingereicht als Kandidatur für die KI-Leuchttürme an der nationalen KI-Community-Veranstaltung vom 14. September 2026</li>
          ...
          <div className="section-card" id="ki-fuer-alle">
            ...
            <p>
              ...
              Stream 1 befasst sich mit der technischen Architektur und dem finanziellen Betriebsmodell
              für KI in der Bundesverwaltung.
            </p>

            <h3>Meine Rolle:</h3>
            <p>
              Ich halte einen Praktikersitz in Stream 1 und bringe die operative Perspektive aus KI@V ein,
              einer souveränen KI-Plattform innerhalb der Gruppe Verteidigung mit validiertem ROI über drei
              Anwendungsfälle und aktivem Pilotbetrieb seit Juni 2026.
            </p>
          ...
          <div className="section-card" id="cockpit">
            ...
            <h3>Ziel: Ersatz eines fragmentierten, manuell erstellten Berichtswesens durch automatisierte Portfolio-Intelligence über isolierte Departemente des ASTAB hinweg.</h3>

            <h3>Meine Rolle:</h3>
            <p>
              Ich leitete die gesamte Umsetzung innerhalb der Digital Factory Verteidigung (Value Stream
              Militärverwaltung), ausgeführt über 5 Program Increments im Rahmen eines fixen Budgets für
            ...
            <ul>
              ...
              <li>Im Scope, im Budget, innerhalb von 5 PIs geliefert</li>
            </ul>
          ...
          <div className="section-card" id="ttr">
            ...
            <ul>
              ...
              <li>Sicherung eines EU-Horizon-Förderbeitrags (der erste EU-Förderbeitrag überhaupt für den FTE), zur Finanzierung dieser Entwicklung</li>
          ...
          <div className="section-card" id="pain-corner">
            ...
            <p>
              ...
              und Apothekenpartnerschaften, das im Massstab funktioniert, in öffentlichen
            ...
            <ul>
              ...
              <li>Entwicklung eines massgeschneiderten SMS-basierten Fernwiederherstellungsmechanismus, der die Systemverfügbarkeit über das nationale Installationsnetzwerk ohne Vor-Ort-Einsatz wiederherstellte</li>
          ...
          <div className="section-card" id="iot-maximo">
            ...
            <h3>Ergebnisse:</h3>
            <ul>
              <li>Entwurf von zustandsbasierten Wartungsmustern, die die kalenderbasierte Planung ablösten, mit Live-Telemetrie aus heterogenen Sensorumgebungen, integriert in IBM Maximo 7.5/7.6</li>

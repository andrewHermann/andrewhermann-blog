...
const TermsOfUse = () => {
  const termsBreadcrumbs = [
    ...
    { name: "Terms of Use", url: "https://andrewhermann.com/terms" }
  ]
  ...
  return (
    <div className="terms-container">
      <SEO
        ...
        url="https://andrewhermann.com/terms"
      ...
      <div className="terms-content">
        <div className="terms-header">
          ...
          <p className="terms-subtitle">Last updated: January 19, 2025</p>
        </div>
        ...
        <div className="terms-body">
          <section className="terms-section">
            ...
            <p>
              By accessing and using this website (andrewhermann.com), you accept and agree to be bound by the terms and provision of this agreement. These Terms of Use govern your use of this website and any services provided through it.
            </p>
          </section>
